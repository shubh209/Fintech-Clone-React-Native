import { Alert, Platform, StyleSheet, Text, TextInputProps, TouchableOpacity, View } from 'react-native'
...
const phone = () => {
    ...
    return (
        <View style={defaultStyles.container}>
            ...
            <Text style={defaultStyles.descriptionText}>Please enter the 6-digit code sent to {phone}</Text>
